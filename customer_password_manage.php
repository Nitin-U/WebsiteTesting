  ...
  <div class="main">
    <form action="" method="POST">
      <br>
        ...
        <input type="password" id="pcurrent" name="currentpass"><br>
        ...
        <input type="password" id="pnew" name="newpass"><br>
        ...
        <input type="password" id="pconfirm" name="confirmpass"><br>
        <div class="mb-3"><?php if (isset($error_confirm)) echo '<div class="error">'.$error_confirm.'</div>';?></div>

        <!-- <div class="row">
			    <div class="col-12 md-5 text-center">
          <button type="button" class="btn btn-white mx-auto col-4" id="abc">Update</button>
			    </div>
		    </div> -->
        <div class="col-md-12"> 
   			    <div class="card-text text-center">
   				    <button type="submit" class="btn btn-white text-light" name="btnSubmit" id="abc">Update</button> <br/><br/>
   			    </div>
   		    </div>
   	    </div>
    </form>
