                    ...
                    <div class="leftbar">
                        <form action="" method="GET">
                                ...
                                <?php 
                                    ...
                                    while ($row = oci_fetch_assoc($traderSql_Result)) { ?>
                                       <li class="list-category">
                                        <input class="form-check-input" type="radio" name="catg" id="<?php echo $row['SHOP_TYPE']?>" value= "<?php echo $row['USER_ID']?>"> 
                            ...
                            <div class="price_input p-2">
                                <div class="col-12">
                                    <input class="number_input" type="number" name="min" placeholder="Min" min="1" max="999"> - <input class="number_input" type="number" name="max" placeholder="Max" min="1" max="999">
                                </div>
                                <!--div class="col-12">
                    ...
                    <div class="sort">
                        ...
                        <div class="row">
                             ...
                             if(isset($_GET['search']))
                            {
                                ...
                                $query.= " AND CONCAT(PRODUCT_NAME,SHOP) LIKE '%".$search."%'";
                            }
