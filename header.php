...
<head>
	...
	<body>
		...
		<nav class="navbar navbar-expand-lg bg-dark text-dark col-12 px-0 sticky-top">
				...
				<nav class="navbar navbar-expand-md navbar-light bg-light p-1">
				  ...
				  <div class="collapse navbar-collapse" id="navbarSupportedContent">
				    <ul class="nav-sec navbar-nav mx-auto">
				      ...
				      <li class="nav-item active mx-auto">
				        <a class="nav-link navbar-brand mr-4" href="#">About <span class="sr-only">(current)</span></a>
				      </li>
				      <li class="nav-item active mx-auto">
				      ...
				      <!--li class="nav-item active mx-auto">
				       ...
				       <li class="nav-item dropdown mx-auto my-auto">
				        ...
				        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
				          <a class="dropdown-item" href="register_customer.php">Customer SignUp</a>
				          <a class="dropdown-item" href="register_trader.php">Trader SignUp</a>
				        </div>  
				      </li>
