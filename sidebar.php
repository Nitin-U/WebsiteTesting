<div class="sidenav">
    <a class="<?php if($_SERVER['PHP_SELF'] == '/Website testing/trader_profile_setting.php') echo 'active'?>" href="trader_profile_setting.php">&nbsp; <i class="fa fa-user" style="color:white;"></i> &nbsp; My Profile</a>

    <button class="dropdown-btn">
      &nbsp;<i class="fa fa-shopping-cart" style="color:white;"></i> &nbsp; Products<i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-container">
      <a class="<?php if($_SERVER['PHP_SELF'] == '/Website testing/addProduct.php') echo 'active'?>" href="addProduct.php">Add Products</a>
